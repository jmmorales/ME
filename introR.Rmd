...
Algo interesante para ver en un set de datos como este es el "factor reproductivo" o "tasa finita de incremento de la población", que no es otra cosa que $n(t+1) / n(t)$. Por ejemplo, para el $2010$ la tasa de crecimiento fue de: `n[2]/n[1]` $=$ `r n[2]/n[1]`.
